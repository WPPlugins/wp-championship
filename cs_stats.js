...
function wpc_stats1_update() {
    ...
    jQuery.post(wpcobj.wpc_ajaxurl+"?action=update_Stats1", 
...
function wpc_stats4_update() {
    ...
    jQuery.post(wpcobj.wpc_ajaxurl+"?action=update_Stats4", 
...
function wpc_stats5_update() {
    ...
    jQuery.post(wpcobj.wpc_ajaxurl+"?action=update_Stats5",  
...
function wpc_stats6_update() {
    ...
    jQuery.post(wpcobj.wpc_ajaxurl+"?action=update_Stats6",  
...
function wpc_stats7_update() {
    ...
    jQuery.post(wpcobj.wpc_ajaxurl+"?action=update_Stats7",  
